...
session_start();
		if(!isset($_SESSION["mobile_no"])){
			header("Location:user-login.php");
						...
						$mobno=$_SESSION["mobile_no"];
						
						$getselectitems="SELECT DISTINCT oid FROM orders where umobileno='$mobno' ORDER BY oid ";
...
<form action="dbuser-getorderdetails.php" method="POST" enctype="multipart/form-data">
											...
											<div class="controls">
											<select name="orderno" style="text-transform: uppercase;width: 100%;text-align: center;" id="subcategory" class="span8 tip" required >
												<?php
